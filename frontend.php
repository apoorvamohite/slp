        ...
        <div class="page-header page-header-small">
            ...
            <div class="content-center">
                <div class="container">
                    ...
                    <h1 id="heading" class="h1" style="font-family: 'Graduate', cursive;">Update</h1>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-6 text-center col-md-8 ml-auto mr-auto">
                        <form method="POST" action="script.php">
                            ...
                            <div class="send-button">
                                <input class="btn btn-primary btn-round btn-block btn-lg" value="Submit" type="submit" />
                            </div>
                        </form>
                    </div>
                </div>
